...
function initCaseList() {
    var b = $(window).width();
    860 > b && 0 == $(".rbslider-item-list-rbslider").size() ? ($(".case-list,.equipment-list").addClass("rbslider-item-list-rbslider").addClass("rbslider-container").find("ul").addClass("rbslider-wrapper").find("li").addClass("rbslider-slide"),
    rbsliderInterval = setInterval(function() {
        var a = $(".case-list .rbslider-slide").width();
        a > .88 * a && (clearInterval(rbsliderInterval),
        $(".rbslider-item-list-container .navigation").show(),
        rbslider2 = new Rbslider(".case-list",{
    ...
    rbsliderInterval2 = setInterval(function() {
        var a = $(".equipment-list .rbslider-slide").width();
        a > .88 * a && (clearInterval(rbsliderInterval2),
        rbslider2 = new Rbslider(".equipment-list",{
    ...
    }, 300)) : 860 < b && 0 < $(".rbslider-item-list-rbslider").size() && (clearInterval(rbsliderInterval),
    rbslider2 && rbslider2.destroy(),
    clearInterval(rbsliderInterval2),
    rbslider3 && rbslider3.destroy(),
    $(".rbslider-item-list-container .navigation").hide(),
    $(".case-list,.equipment-list").removeClass("rbslider-container").removeClass("rbslider-item-list-rbslider"),
    $(".case-list").html(caseListHtml),
...
$(function() {
    ...
    (function() {
        function a() {
            ...
            700 < $(window).width() ? (a = a.offset().top - c.top,
            $(".home-about-navi li.bg").css({
                top: a,
                left: 0
            })) : (a = a.offset().left - c.left,
            $(".home-about-navi li.bg").css({
                left: a,
                top: 0
            }));
        ...
        $(".home-about-navi li").mouseenter(function() {
            if (700 < $(window).width()) {
                ...
                b = $(this).offset().left - $(".home-about-navi").offset().left,
                $(".home-about-navi li.bg").css({
                    left: b,
                    top: 0
                });
